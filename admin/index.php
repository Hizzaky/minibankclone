        ...
        <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white">
            <div class="position-sticky">
                <div class="list-group list-group-flush mx-3 mt-4">
                    ...
                    <a href="pengajuan" class="list-group-item list-group-item-action py-2 ripple ">
                        <span>Pengajuan Pembiayaan Nasabah</span></a>
                    <a href="proses" class="list-group-item list-group-item-action py-2 ripple ">
                        <span>Cicilan Pembiayaan Nasabah</span></a>
