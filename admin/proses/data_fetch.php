...
$columns = array('id_nasabah', 'nama_nasabah', 'jenis_identitas_utama', 'jenis_pekerjaan', 'nama_instansi_pekerjaan', 'jabatan_pekerjaan', 'hp_pribadi', 'email', 'produk', 'kk', 'ktp', 'pengajuan_nasabah', 'pengajuan_cs', 'pengajuan_admin');

$query = "SELECT * FROM v_pengajuan_admin ";
...
while($row = mysqli_fetch_array($result))
{
 ...
 $sub_array[] = '<a class="btn btn-info btn-xs" href="cek.php?nid='.$row["id_nasabah"].'" style="text-decoration:none; color:white">Cek Kelengkapan Data</a>';
...
{
 $query = "SELECT * FROM v_pengajuan_cs ";
