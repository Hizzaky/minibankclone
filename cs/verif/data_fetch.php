...
$query = "SELECT * FROM v_nasabah_verif ";
...
while($row = mysqli_fetch_array($result))
{
 ...
 $sub_array[] = '<button type="button" name="'.$row["nama_nasabah"].'" class="btn btn-info btn-xs acc" id="'.$row["id"].'" idd="'.$row["username"].'">Setujui</button>';
