	...
	<form action="form-ttd-pemohon.php" method="POST" enctype="multipart/form-data">	
		...
		<div class="container">
				...
				<div style="padding: 2em;">
					...
					<div class="container">
						...
						<div style="text-align: center;">
							<label>Rp. <span id="total_ppa">0</span></label>
							<input id="total_tetapa" type="text" name="total_tetap" value="0" style="display: none;">
						</div>
					</div><hr>
					...
					<div class="container">
						...
						<div style="text-align: center;">
							<label>Rp. <span id="total_ppb">0</span></label>
							<input id="total_tetapb" type="text" name="total_xtetap" value="0" style="display: none;">
						</div>
					</div>
				</div>
			</div>
			<div class="container">
				...
				<button class="btn btn-info form-control">Selanjutnya</button>
			</div><br>
		</div>	<hr>
	</form>
</body>
...
<script type="text/javascript">
	$("input").keyup(function () {
	    ...
	    var totalppa1 = (parseFloat(pokok)+parseFloat(tunjangan))-(parseFloat(potongan)+parseFloat(cicilan));
	    $("#hasil_tetap_pemohon").text(totalppa1);
	    // END PEMOHON TETAP
		// PASANGAN TETAP
	    ...
	    var totalppa2 = (parseFloat(pokok)+parseFloat(tunjangan))-(parseFloat(potongan)+parseFloat(cicilan));
	    $("#hasil_tetap_pasangan").text(totalppa2);

	    $("#total_ppa").text(totalppa1+totalppa2); // TOTAL PEMOHON & PASANGAN
	    $("#total_tetapa").val(totalppa1+totalppa2); // TOTAL PEMOHON & PASANGAN
	    // END PEMOHON TETAP
		// PEMOHON TIDAK TETAP
	    ...
	    var totalppb1 = (parseFloat(pokok)+parseFloat(tunjangan))-(parseFloat(potongan)+parseFloat(cicilan));
	    $("#hasil_xtetap_pemohon").text(totalppb1);
	    ...
	    var totalppb2 = (parseFloat(pokok)+parseFloat(tunjangan))-(parseFloat(potongan)+parseFloat(cicilan));
	    $("#hasil_xtetap_pasangan").text(totalppb2);
	    // END PEMOHON TIDAK TETAP
	    $("#total_ppb").text(totalppb1+totalppb2); // TOTAL PEMOHON & PASANGAN
	    $("#total_tetapb").val(totalppb1+totalppb2); // TOTAL PEMOHON & PASANGAN
	});
</script>