	...
	<form action="upload.php" method="POST" enctype="multipart/form-data">	
		<!-- <div class="container"> -->
				...
				<div class="row">
						<div class="card-body">
							<div class="form-group mb-3">
								<label class="label" for="">Tanda Tangan Pasangan</label><br><br>
								<div class="row">
									...
									<div class="col-sm-5">
										<div class="form-inline">
											...
											<div>
												<input type="hidden" name="signature_pasangan" />
												<div style="padding-left: 1em;">
													<?php if (!is_null($_SESSION['nama_menikah']) || !empty($_SESSION['nama_menikah']) || !$_SESSION['nama_menikah']==""): ?>
														<label><?php echo $_SESSION['nama_menikah'] ?></label>
													<?php endif ?>
			...
			<div class="container2" style="text-align: center;">
				<hr>
				<button class="btn btn-primary" style="width: 80%; height: 3em;">Simpan</button>
			</div>
		<!-- </div>	 -->
	</form>
...
<script type="text/javascript">
	...
	var prevX, prevY;
	var currX, currY;
	var signature = document.getElementsByName('signature_pasangan')[0];
